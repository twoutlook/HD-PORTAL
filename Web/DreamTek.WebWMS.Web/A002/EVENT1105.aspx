...
")%>
                  <hr />
                  <h3>入庫單</h3>
                   <p>可用casnid 找到入庫通知單</p>
     <%=GetHtmlTableWhRec(@"

SELECT cticketcode,T2.cinvcode,T2.cinvname,iquantity,cpositioncode,cposition,T3.palletcode,casnid
...
SELECT cticketcode, cinvcode,cinvname,iquantity,T1.id
